...
struct SynthNode;
typedef void(SYNTHCALL *SynthFunction)(SynthNode*);
...
enum SIGNAL_VISUALIZER_MODE_ENUM
{
	...
	SIGNAL_VISUALIZER_SPECTRUM  = 3,
	SIGNAL_VISUALIZER_RAW_TIMELINE = 4,
	SIGNAL_VISUALIZER_SPECTRUM_TIMELINE  = 5,
	...
	SIGNAL_VISUALIZER_WINMASK     = 0x0300,  // bits [9:8]: FFT window function
	SIGNAL_VISUALIZER_WINSHIFT    = 8,
	SIGNAL_VISUALIZER_CHANMASK    = 0x0C00,  // bits [11:10]: channel mix before FFT
	SIGNAL_VISUALIZER_CHANSHIFT   = 10,
	SIGNAL_VISUALIZER_FFTMASK     = 0x7000,  // bits [14:12]: FFT size
	SIGNAL_VISUALIZER_FFTSHIFT    = 12,
	SIGNAL_VISUALIZER_SLOPEMASK   = 0x18000, // bits [16:15]: display slope (0=off,1=1.5,2=3,3=4.5 dB/oct)
	SIGNAL_VISUALIZER_SLOPESHIFT  = 15,
};
...
#ifdef COMPILE_VSTI
	int			RawWaveFormat[32]; // formats for the rawwavetables
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// node hierarchy create/delete functions
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
