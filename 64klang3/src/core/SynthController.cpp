...
DWORD NodeInputs[MAXIMUM_ID] =
{
	...
	VOICEPARAM_MAX, //VOICE_AFTERTOUCH_MAX,
	
	// vsti specific
#ifdef COMPILE_VSTI
	SIGNAL_VISUALIZER_MAX, //SIGNAL_VISUALIZER_MAX,
#endif
};
...
DWORD NodeReqGUISignals[MAXIMUM_ID] =
{
	...
	VOICEPARAM_REQ_GUI_SIGNALS, //VOICE_AFTERTOUCH_MAX,

	// vsti specific
#ifdef COMPILE_VSTI
	SIGNAL_VISUALIZER_REQ_GUI_SIGNALS, //SIGNAL_VISUALIZER_REQ_GUI_SIGNALS,
#endif
};
...
DWORD NodeMaxGUISignals[MAXIMUM_ID] =
{
	...
	VOICEPARAM_MAX_GUI_SIGNALS, //VOICE_AFTERTOUCH_MAX,
	
	// vsti specific
#ifdef COMPILE_VSTI
	SIGNAL_VISUALIZER_MAX_GUI_SIGNALS, //SIGNAL_VISUALIZER_MAX_GUI_SIGNALS,
#endif
};
...
#define DEFMODE(x, val)        if (idx == (x)) { outL = outR = (double)(int)(val); return; }
	...
	case FOURIOZA_ID:
		...
		DEFCONST(FOURIOZA_STRETCH,     0.0);
		DEFCONST(FOURIOZA_PHASESMOOTH, 0.0);
		DEFCONST(FOURIOZA_HARMONICSMOOTH,    0.0);
		DEFCONST(FOURIOZA_HARMONICSBASEFREQ, 0.41024); // ~128 Hz in exponential 10..5000 Hz mapping
		DEFCONST(FOURIOZA_HARMONICSBW, 0.1245622811405703); // 25 cents in 0.1..200 mapping
		DEFCONST(FOURIOZA_NUMHARMONICS, 0.0); // 0 = disabled
		DEFCONST(FOURIOZA_LOWCUT,      0.0);
		DEFCONST(FOURIOZA_HIGHCUT,     1.0);
		DEFCONST(FOURIOZA_FREQSHIFT,   0.0);
		DEFCONST(FOURIOZA_BASEPITCH,   0.0);
		DEFCONST2(FOURIOZA_LAYERPITCH, 0.09375, 0.09375*2);
		DEFCONST2(FOURIOZA_LAYERMIX,   0.0, 0.0);
	...
	case SIGNAL_VISUALIZER_ID:
		...
		DEFMODE(SIGNAL_VISUALIZER_MODE, 0x4303);
		break;
#endif
	default: break;
	}
