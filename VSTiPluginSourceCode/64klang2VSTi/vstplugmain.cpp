...
BOOL WINAPI DllMain (HINSTANCE hInst, DWORD dwReason, LPVOID lpvReserved)
{
	switch (dwReason)
	{
		case DLL_PROCESS_ATTACH:
			//MessageBoxA(NULL, "DLL_PROCESS_ATTACH", "DllMain", MB_OK);
			SynthController::instance()->ModuleInstance = hInst;            
			break;
		case DLL_PROCESS_DETACH:
			//MessageBoxA(NULL, "DLL_PROCESS_DETACH", "DllMain", MB_OK);
			break;
		case DLL_THREAD_ATTACH:
			//MessageBoxA(NULL, "DLL_THREAD_ATTACH", "DllMain", MB_OK);
			break;
		case DLL_THREAD_DETACH:
			//MessageBoxA(NULL, "DLL_THREAD_DETACH", "DllMain", MB_OK);
			break;
	}
	return 1;
}
